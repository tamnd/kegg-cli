...
Most of these come down to network reality or how kegg serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

kegg rate-limits like any public site. kegg already paces
...
Where a surface is gated, kegg reads a cookie or token you supply
...
`kegg`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what kegg actually did
